"""
TIMEVIEW-Extended: Causal Interventions and Decision Utility
------------------------------------------------------------
This module implements two major extensions to TIMEVIEW:
1. Response-Aware Interventions: Modeling how dynamic treatments (like
   Mechanical Ventilation) shift the trajectory distribution.
2. Decision Utility: Quantifying the "clinical value" of interpretability
   by using inferred coefficients for downstream mortality prediction.

Dependencies: requires timeview_adaptive.py in the same directory.
"""
